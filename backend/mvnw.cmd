...
@REM Download and unpack Maven if not present
set "MAVEN_HOME=%USERPROFILE%\.m2\wrapper\dists"

@REM Simple: use the java -jar approach with the wrapper jar if present
...
@REM Fallback: Download maven-wrapper.jar then run it
...
@REM Fallback to globally installed mvn
set MAVEN_CMD=mvn
%MAVEN_CMD% %*
if ERRORLEVEL 1 goto error
goto end
